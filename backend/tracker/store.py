"""Self-improving tracker: sqlite log of picks, CLV, calibration, threshold tuning."""
...
def log_pick(sport: str, event_id: str, event_label: str, market: str, outcome: str,
             ...
             model_prob: float | None = None, surface: str = "") -> int:
    c = _db()
    cur = c.execute(
...
def settle_pick(pick_id: int, result: str, closing_fair_odds: float | None = None) -> None:
...
def calibration(n_bins: int = 5) -> list[dict]:
